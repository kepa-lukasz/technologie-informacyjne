const data = {
    ...
    <ol>
        <li>
            Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem: https://www.techsquare.pl
        </li>
        <li>
            Operatorem serwisu oraz Administratorem danych osobowych jest: TechSquare.pl Wejherowska 11/2 54-515, NIP: 9131282995
        </li>
        <li>
            Adres kontaktowy poczty elektronicznej operatora: contact@techsquare.pl
        </li>
        <li>
