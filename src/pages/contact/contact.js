...
function Contact() {
    ...
    return (
        ...
        <Container fluid className="contactBody p-0 pt-5">
            <Container className="py-5 d-flex" data-aos="fade-up" data-aos-delay="150" style={{ zIndex: "15", position: 'relative' }}>
                <Container className="FormBody px-2 px-sm-5 py-5">
                    <Box sx={{ width: '100%' }}>
                        ...
                        {/* <Stepper className="stepperClass mb-5" activeStep={activeStep} orientation="vertical">
                                ...
                                {/* {
                                    !selectedAllOptions ? (!isSelected ?
                                        ...
                                        <form data-aos="zoom-in-up" className="my-4">
                                            <div className="d-flex p-0" style={{ width: "85%" }}>
                                                <Row>
